...
?>
				...
				<div id="progressBars">
					<div id="progressBarOne">
						...
						<?php 
								...
								{
							?>
									<em><b style="color:green"> <?= $_SESSION['opinionOneForThisPatient']; ?> (<?= round($totalSubmitOnePercentageForThisPatient, 2) ?>%)	</b></em>					
							<?php
								}
								...
								{	 
							?>
									<em><b style="color:orange"> <?= $_SESSION['opinionOneForThisPatient']; ?> (<?= round($totalSubmitOnePercentageForThisPatient, 2) ?>%)	</b></em>	
							<?php
								}
								...
								{
							?>
									<em><b style="color:red"> <?= $_SESSION['opinionOneForThisPatient']; ?> (<?= round($totalSubmitOnePercentageForThisPatient, 2) ?>%)	</b></em>
							<?php	
								}
							?>	
					</div>
					...
					<div id="progressBarTwo">
						...
						<?php 
							...
							{
						?>
								<em><b style="color:green"> <?= $_SESSION['opinionTwoForThisPatient']; ?> (<?= round($totalSubmitTwoPercentageForThisPatient, 2) ?>%)	</b></em>					
						<?php
							}
							...
							{	 
						?>
								<em><b style="color:orange"> <?= $_SESSION['opinionTwoForThisPatient']; ?> (<?= round($totalSubmitTwoPercentageForThisPatient, 2) ?>%)	</b></em>	
						<?php
							}
							...
							{
						?>
								<em><b style="color:red"> <?= $_SESSION['opinionTwoForThisPatient']; ?> (<?= round($totalSubmitTwoPercentageForThisPatient, 2) ?>%)	</b></em>
						<?php	
							}
						?>
					</div>
					...
					<div id="progressBarThree">
						...
						<?php 
							...
							{
						?>
								<em><b style="color:green"> <?= $_SESSION['opinionThreeForThisPatient']; ?> (<?= round($totalSubmitThreePercentageForThisPatient, 2) ?>%)	</b></em>					
						<?php
							}
							...
							{	 
						?>
								<em><b style="color:orange"> <?= $_SESSION['opinionThreeForThisPatient']; ?> (<?= round($totalSubmitThreePercentageForThisPatient, 2) ?>%)	</b></em>	
						<?php
							}
							...
							{
						?>
								<em><b style="color:red"> <?= $_SESSION['opinionThreeForThisPatient']; ?> (<?= round($totalSubmitThreePercentageForThisPatient, 2) ?>%)	</b></em>
						<?php	
							}
						?>
					</div>
					...
					<div id="progressBarFour">
						...
						{
						?>
								<em><b style="color:green"> Taux Globale de <?= round($totalAllOverPercentageForThisPatient, 2) ?>%	</b></em>					
						<?php
							}
							...
							{	 
						?>
								<em><b style="color:orange"> Taux Globale de <?= round($totalAllOverPercentageForThisPatient, 2) ?>%	</b></em>	
						<?php
							}
							...
							{
						?>
								<em><b style="color:red"> Taux Globale de <?= round($totalAllOverPercentageForThisPatient, 2) ?>%</b></em>
						<?php	
							}
						?>
					</div>
		...
		<!-- -------------------------------- END RESULT TO PRINT ------------------------------- -->
			...
			<br>
			<center>
				<button id="saveTestDNSButton">Enregistrer Avec Partage</button>
				<br>
