...
?>
		...
		<?php
			...
			?>
			<h2 id="testTitle">TEST GDS</h2>
			<div id="fullQuestions1Bloc">
				<br><br>
				<center>
					<h2 style="font-family: Segoe UI Light;">TEST GDSE (Gestion Du Stress Enfant)</h2>
					<br><br><br><br>
				...
				<form id="fontDesign" method="POST" action="index.php?action=startGDSETest">
					<input type="submit" id="nextPageButton" value="Commencer" name="commencer">
				</form>
			</div>
		</body>
		<script type="text/javascript" src="view/testGDSE/main2.js"></script>
		</html>
<?php
	}
