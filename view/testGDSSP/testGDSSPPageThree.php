...
?>
		...
		<?php
			...
			<div id="fullQuestions1Bloc">
				...
				<form id="fontDesign" method="POST" action="index.php?action=testDNSSubmitThree">
					<center>
						<h3>Signes évocateurs d'une insuffisance en Sérotonine</h3>
					</center>
					
					<h4>Question 1</h4>
					<h4>Je suis irritable, impulsif et vite en coulère</h4>
					...
					<h4>Question 5</h4>
					<h4>Je me sens dépendant facilement : tabac, alcool,</h4>
					...
					<h4>Question 6</h4>
					<h4>J'ai du mall à prendre du recul, à rester zen</h4>
