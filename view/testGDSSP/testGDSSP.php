...
?>
		...
		<head>
			...
			<link rel="stylesheet" type="text/css" href="view/testGDSSP/style.css?version=1">
			<link rel="stylesheet" type="text/css" href="lib/css/styleMenubar.css?version=1">
			<link rel="icon" type="image/png" href="view/testGDSSP/images/logo.png" />
			<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
			<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>
			<title>Test GDSSP - Consults</title>
		</head>
		<body id="setFont">
		...
		<?php
			...
			<h2 id="testTitle">TEST GDSSP</h2>
		
			<div id="fullQuestions1Bloc">
				<br><br>
				<center>
					<h1 style="font-family: Segoe UI Light;">Questionnaire GDSSP</h1>
					<h2 style="font-family: Segoe UI Light;">(Gestion Du Stress Symptômes Physiques)</h2>
					<br><br><br><br>
					...
					<p><em>"pas du tout" (0 point)</em></p>
					<p><em>"un peu" (1 point)</em></p>
					<p><em>"modérément" (2 points)</em></p>
					<p><em>"beaucoup" (3 points)</em></p>
				...
				<form id="fontDesign" method="POST" action="index.php?action=testGDSSPSubmitOne">
					<center>
		...
		<script type="text/javascript" src="view/testGDSSP/main2.js"></script>
		</html>
<?php
	}
