...
?>
		...
		<head>
			...
			<title>Résultat GDSSP - Consults</title>
		</head>
		<body id="setFont">
			...
			<div id="dnsBlocToDownload">
				...
				<div id="progressBars">
						...
						<svg viewBox="0 0 36 36" width="360" height="360" class="circular-chart">
						  ...
						  />
							...
							<?php 
								...
								{
							?>
									<em><b style="color:green"> <?= $_SESSION['opinionOne']; ?> (<?= $totalSubmitOnePercentage ?>%)	</b></em>					
							<?php
								}
								...
								{	 
							?>
									<em><b style="color:orange"> <?= $_SESSION['opinionOne']; ?> (<?= $totalSubmitOnePercentage ?>%)	</b></em>	
							<?php
								}
								...
								{
							?>
									<em><b style="color:red"> <?= $_SESSION['opinionOne']; ?> (<?= $totalSubmitOnePercentage ?>%)	</b></em>
							<?php	
								}
							?>		
					</div>
					...
					<div id="progressBarTwo">
						...
						{
						?>
								<em><b style="color:green"> <?= $_SESSION['opinionTwo']; ?> (<?= $totalSubmitTwoPercentage ?>%)	</b></em>					
						<?php
							}
							...
							{	 
						?>
								<em><b style="color:orange"> <?= $_SESSION['opinionTwo']; ?> (<?= $totalSubmitTwoPercentage ?>%)	</b></em>	
						<?php
							}
							...
							{
						?>
								<em><b style="color:red"> <?= $_SESSION['opinionTwo']; ?> (<?= $totalSubmitTwoPercentage ?>%)	</b></em>
						<?php	
							}
						?>
					</div>
					...
					<div id="progressBarThree">
						...
						<?php 
								...
								{
							?>
									<em><b style="color:green"> <?= $_SESSION['opinionThree']; ?> (<?= $totalSubmitThreePercentage ?>%)	</b></em>					
							<?php
								}
								...
								{	 
							?>
									<em><b style="color:orange"> <?= $_SESSION['opinionThree']; ?> (<?= $totalSubmitThreePercentage ?>%)	</b></em>	
							<?php
								}
								...
								{
							?>
									<em><b style="color:red"> <?= $_SESSION['opinionThree']; ?> (<?= $totalSubmitThreePercentage ?>%)	</b></em>
							<?php	
								}
							?>
					</div>
					...
					<div id="progressBarFour">
						...
						<?php 
							...
							{
							?>
									<em><b style="color:green"> Taux Globale de <?= $totalAllOverPercentage ?>%	</b></em>					
							<?php
								}
								...
								{	 
							?>
									<em><b style="color:orange"> Taux Globale de <?= $totalAllOverPercentage ?>%	</b></em>	
							<?php
								}
								...
								{
							?>
									<em><b style="color:red"> Taux Globale de <?= $totalAllOverPercentage ?>%</b></em>
							<?php	
								}
							?>
					</div>
		...
		<script type="text/javascript" src="view/testGDSSP/main.js"></script>
		</html>
<?php
	}
