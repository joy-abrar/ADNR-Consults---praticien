<?php
	...
	<html>
		<head>
			...
			<!------- END LOADING SCREEN ------- -->
			<title>ADNR Consults - Clients enfants</title>
		</head>
		<body id="body">
			<!------------ LOADING SCREEN ------------->
			...
			<div id="mainAppearence">
				...
				<h2 id="testTitle">CLIENTS ENFANTS</h2>
				...
				?>
						...
						<!--<center id="clientListBloc">
							<h5>Vous n'avez aucun client enfant pour le moment</h5>
						</center>-->
				...
				<?php
					...
					{
						while($rows = $showChildClientsFromConnections -> fetch())
							{
								$clientId = $rows['clientId'];
								$getChildClientsFromUsersThroughConnections = $userManager-> getChildClientsFromUsersThroughConnections($clientId);

								while($rows2 = $getChildClientsFromUsersThroughConnections-> fetch())
								{
