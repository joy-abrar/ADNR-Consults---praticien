	...
	?>
		...
		<html>
			...
			<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
				...
				<!------- END LOADING SCREEN ------- -->
				<title>ADNR Consults - Clients Adolescents</title>
			</head>
			<body id="body">
				<!------------ LOADING SCREEN ------------->
			...
			?>
				...
				<div id="mainAppearence">
					...
					<h2 id="testTitle">CLIENTS ADOLESCENTS</h2>
					...
					<input type="text" id="mySearchBox" onkeyup="myFunction()" placeholder="Rechercher un client...">	
						...
						<?php
							...
							{
								while($rows = $showTeenClientsFromConnections -> fetch())
								{
									$clientId = $rows['clientId'];
									$getTeenClientsFromUsersThroughConnections = $userManager-> getTeenClientsFromUsersThroughConnections($clientId);

									while($rows2 = $getTeenClientsFromUsersThroughConnections-> fetch())
									{
