		...
		<body id="setFont">
			...
			<div id="fullQuestions1Bloc">
				...
				<center>
					...
					<br><br><br>
					<form id="fontDesign" method="POST" action="index.php?action=calculateGDSResult">
						<table class="zebra"> 
							<thead> 
								<tr>
									<th>Sélection</th> 
							...
							<tbody id="myTable"> 
								...
								<tr> 
									<td><input type="checkbox" name="GDSQuestion1" value=73></td>
								...
								<tr> 
									<td><input type="checkbox" name="GDSQuestion12" value=35></td>
								...
								<tr> 
									<td><input type="checkbox" name="GDSQuestion28" value=29></td>
