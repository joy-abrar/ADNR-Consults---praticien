<?php
        ...
        try {
            ...
            $mail->Username   = 'abrarjoy11@gmail.com';                //SMTP username
            $mail->Password   = 'Allahuakbar&1';                               //SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
            $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

            //Recipients
            $mail->setFrom('abrarjoy11@gmail.com', 'Admin ADNR');
            $mail->addAddress($addressToSend , 'Nom dutilisateur');     //Add a recipient
            ...
            */
            ...
            $mail->Subject = 'Voici votre proposition';
            $mail->Body    = " " . $mailText;
