...
?>
		...
		<head>
			...
			<link rel="stylesheet" type="text/css" href="view/testGDSEForThisPatient/style.css?version=1">
			<link rel="stylesheet" type="text/css" href="lib/css/styleMenubar.css?version=1">
			<link rel="icon" type="image/png" href="view/testGDSEForThisPatient/images/logo.png" />
			<script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.9.2/html2pdf.bundle.js"></script>
			<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>
			<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
			<title>Praticien - Résultat GDSE</title>
		</head>
		<body id="setFont">
		...
		<div id="testGDSResultToPrint">
			<h2 id="testTitle">RESULTAT TEST GDSE</h2>
		...
		<div id="myModal" class="modal">
		  <div class="modal-content">
		    ...
		    <form method="POST" action="index.php?action=saveBilanGDSEToClientProfil" class="modal-footer">
		...
		<div id="myModal2" class="modal2">
			<div class="modal-content">
			    ...
			    <form method="POST" action="index.php?action=saveBilanGDSEToClientProfilWithoutSharing" class="modal-footer">
			      	<center id="deletingConfirmationButtonsParam">
			...
			<center>
				...
				<br>
				<a id="nextPageButton" href="index.php?action=endTestGDSEForThisPatientAndGoHome">Terminer</a>
			</center>


		</body>
		<script type="text/javascript" src="view/testGDSEForThisPatient/main.js"></script>
		</html>
<?php
	}
