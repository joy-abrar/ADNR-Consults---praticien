...
{
    const element = document.getElementById('testGDSResultToPrint');
    //console.log(element);
    //console.log(window);
    var opt = {
        margin: 0,
        filename: "bilan GDSE.pdf",
        image: {
            type: 'jpeg',
            quality: 1
        },
...
var btn = document.getElementById("saveTestGDSButton");
...
btn.onclick = function() 
{
    ...
    function (pdfAsString)
    {
        ...
        //document.getElementById('saveTestGDSButton').style = "display:none";
    }
    );
}
...
// Get the button that opens the modal
var btn2 = document.getElementById("saveTestGDSButtonWithoutSharing");
...
btn2.onclick = function() 
{
    ...
    const element2 = document.getElementById('testGDSResultToPrint');
    html2pdf().from(element2).toPdf().output('datauristring').then(
    function (pdfAsString)
    {
        var pdfData = pdfAsString;
        document.getElementById('dataInHere2').value = pdfData;
        //document.getElementById('saveTestGDSButtonWithoutSharing').style = "display:none";
    }
    );
}
