<?php
	...
	if (isset($_GET['action'])) 
	{
		...
		if ($_GET['action'] == "saveBilanFleursToClientProfil") 
		{
			if (session_status() === PHP_SESSION_NONE) 
			{
				session_start();
		 	...
		 	$bilanName = "Bilan_Fleurs_" . rand(1000,10000);
			$fleursDeBachFor = $_SESSION['fleursDeBachFor'];
			...
			$controls_admin = new controls_Admin();
			$controls_admin -> saveBilanFleursToClientProfil($bilanName, $fleursDeBachFor, $byPraticien, $shareWithClient, $data);
		}

		if ($_GET['action'] == "saveBilanFleursToClientProfilWithoutSharing") 
		{
			if (session_status() === PHP_SESSION_NONE) 
			{
				session_start();
			...
			$controls_admin = new controls_Admin();
			$controls_admin -> saveBilanFleursToClientProfilWithoutSharing($bilanName, $fleursDeBachFor, $byPraticien, $shareWithClient, $data);
