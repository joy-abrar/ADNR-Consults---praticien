	...
	<body id="setFont">
			...
			<div id="userGuide3">
				<div id="userGuideTitle">
					<h2><u>Consignes pour questionnaire 3</u></h2>
				</div>
				<div id="guideText">
					<center>
						<h4>affinement du choix questionnaire 1 </h4>
						<h5>Quel est mon plus grand problème du moment ? Quels sont les problèmes dont je veux me libérer en premier ?
							<br>
							<u>6 réponses maximum</u></h5>
					</center>
				</div>
				<div id="startQcmButtonDiv">
					<button id="startQcmButton" onclick="endGuide3()">Commencer</button>
				</div>
			</div>

				<!-- -------------------------------------- END USER GUIDE ----------------------------->

		<div id="fullQuestions3Bloc">
			<br><br>
			<center><h1><u>Questionnaire 3</u></h1></center>
			
			<form id="fontDesign" method="POST" action="./index.php?action=inputToDatabaseQuestionnaireTrois">
				<?php
				...
				?>
						...
						<b>Réponse:</b><br>
						<b>OUI: </b> <input type="checkbox" name="<?= $rows['id'] ?>" value="oui"><br>
						<!--
						<b>NON: </b> <input type="checkbox" name="<?= $rows['id'] ?>" value="non"><br>
						-->
						<br><br>
						<hr id="hrParam">
