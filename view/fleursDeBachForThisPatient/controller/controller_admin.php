...
require('model/Manager/userManager.php');
	...
	class controls_Admin
	{
		...
		function saveBilanFleursToClientProfil($bilanName, $fleursDeBachFor, $byPraticien, $shareWithClient, $data)
		{
			$userManager = new userManager();
			

			$getClientDetailsForNotificationMail = $userManager -> getClientDetailsForNotificationMail($fleursDeBachFor);
			...
			include_once('controller/notificationMail/newBilanNotificationMail.php');

			$userManager -> saveBilanFleursToClientProfil($bilanName, $fleursDeBachFor, $byPraticien, $shareWithClient, $data);

			header("location: ../../index.php");
		}

		function saveBilanFleursToClientProfilWithoutSharing($bilanName, $fleursDeBachFor, $byPraticien, $shareWithClient, $data)
		{
			$userManager = new userManager();
			$userManager -> saveBilanFleursToClientProfilWithoutSharing($bilanName, $fleursDeBachFor, $byPraticien, $shareWithClient, $data);
