<?php
	...
	<html>
		<head>
			...
			<!------- END LOADING SCREEN ------- -->
			<title>ADNR Consults - Clients Femmes</title>
		</head>
		<body id="body">
			<!------------ LOADING SCREEN ------------->
			...
			<div id="mainAppearence">
				...
				<h2 id="testTitle">CLIENTS FEMMES</h2>
				...
				?>
						...
						<!--<center id="clientListBloc">
							<h5>Vous n'avez aucun client femme pour le moment</h5>
						</center>-->
				...
				<?php
					...
					{	
							while($rows = $showFemaleClientsFromConnections -> fetch())
							{
								$clientId = $rows['clientId'];
								$getFemaleClientsFromUsersThroughConnections = $userManager-> getFemaleClientsFromUsersThroughConnections($clientId);

								while($rows2 = $getFemaleClientsFromUsersThroughConnections-> fetch())
								{
