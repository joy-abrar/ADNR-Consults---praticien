<?php
        ...
        try {
            ...
            $mail->addAddress(base64_decode($email) , 'Nom dutilisateur');     //Add a recipient
            ...
            */
            ...
            $mail->Subject = 'Pre-création du compte praticien chez ADNR Consults';
            $mail->Body    = "Bonjour " . base64_decode($firstname) . ",<br> <em>Vous venez juste d'effectuer une demande de creation du compte praticien sur notre plateforme et on vous remercie.</em><br><em></em><br> <span>Notre administration etudiera votre demande et vous donnera une reponse dans un bref delai.<br> En attendant, on vous souhaite une excellente Journee.";
