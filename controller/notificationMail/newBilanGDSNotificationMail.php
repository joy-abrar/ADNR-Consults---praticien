<?php
        ...
        try {
            ...
            */
            ...
            $mail->Body    = "Bonjour " . $clientName . ",<br> <em>Votre praticien " . base64_decode($_SESSION['firstName']). " " . base64_decode($_SESSION['lastName']) . " vient juste d'ajouter un nouveau Bilan GDS dans votre espace client.</em><br><em></em><br> <span>Pour le consulter, veuillez bien vous connecter dans votre <a href='adnr-consults.eu/consults/client'>Espace Client</a><br><br> ADNR vous souhaite une excellente Journee.";
