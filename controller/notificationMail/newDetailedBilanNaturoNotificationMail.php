<?php
        ...
        try {
            ...
            */
            ...
            $mail->Subject = 'Un nouveau test ajoute dans votre espace client';
            $mail->Body    = "Bonjour " . $clientName . ",<br> <em>Votre praticien " . $praticienName . " vient juste d'ajouter un nouveau test du Bilan naturo détailé dans votre espace client.</em><br><em></em><br> <span>Pour commencer ce test, veuillez bien vous connecter dans votre <a href='adnr-consults.eu/consults/client'>Espace Client</a> et rendez-vous dans la rubrique <B>Questionnaires de Praticien</b><br><br> ADNR vous souhaite une excellente Journee.";
